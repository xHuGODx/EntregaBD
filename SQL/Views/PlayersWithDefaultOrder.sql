CREATE VIEW PlayerStatsWithDefaultOrder AS
SELECT 
    ...
    CASE 
        WHEN g.Rounds_Won_Team_1 > g.Rounds_Won_Team_2 THEN t1.Nome 
        ELSE t2.Nome 
    END AS WinningTeam,
    CASE 
        WHEN g.Rounds_Won_Team_1 > g.Rounds_Won_Team_2 AND t.Team_ID = m.Team_1_ID THEN 1
        WHEN g.Rounds_Won_Team_2 > g.Rounds_Won_Team_1 AND t.Team_ID = m.Team_2_ID THEN 1
        ELSE 2
    END AS TeamOrder
FROM 
    VALO_PLAYERSTATS ps
